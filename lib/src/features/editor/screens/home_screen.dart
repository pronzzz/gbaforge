...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  Future<void> _renderPreview() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Render failed: $e')));
    } finally {
        ...
        children: [
          ...
          NavigationRail(
            ...
            destinations: const [
              ...
              NavigationRailDestination(icon: Icon(Icons.text_fields), label: Text('Script')),
              NavigationRailDestination(icon: Icon(Icons.image), label: Text('Sprites')),
            ],
          ),
